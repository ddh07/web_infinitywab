...
{{-- Bibliothèque d'icônes pour les éléments Mission/Vision/Valeurs (voir
     x-ui.content-list et l'onglet Contenu de l'admin). Même convention que
     partials.icons.service-icon : une clé texte stockée en base, un switch ici. --}}
<svg {{ $attributes->merge(['class' => $class]) }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    @switch($icon)
        ...
        @break
        @case('trophy')
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.006 0a24.204 24.204 0 01-5.006 0m5.006 0a1.5 1.5 0 001.5-1.5V6.75a1.5 1.5 0 00-1.5-1.5H9.5a1.5 1.5 0 00-1.5 1.5v9c0 .828.672 1.5 1.5 1.5"/>
        @break
        @case('handshake')
        ...
        @break
        @case('flag')
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3v18M3 4.5h12.75l-1.5 3.75 1.5 3.75H3"/>
        @break
        @case('lightbulb')
